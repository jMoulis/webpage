    ...
    <div id="logo-wrapper">
      <ul>
        <li className="logo-list-item">
          <a href="https://certificates.opquast.com/certificate/JHWF2D/" title="Certificat OpQuast">
            <img className="footer-logo" alt="opQuast certification logo" src="/img/opquastBadge.png" />
          </a>
        </li>
        <li className="logo-list-item">
          <a href="http://symfony.com/" title="Symfony website" hrefLang="en">
            <img className="footer-logo" alt="Symfony" src="/img/symfony.png" />
          </a>
        </li>
        <li className="logo-list-item">
          <a href="https://reactjs.org/" title="React website" hrefLang="en">
            <img className="footer-logo" alt="React" src="/img/react.png" />
          </a>
        </li>
        <li className="logo-list-item">
          <a href="https://oclock.io/" title="Ecole O'Clock - website" hrefLang="fr">
